...
for (p in 1:length(idy))
{
  ...
  #Write to NetCDF
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/tasmin/CurC/xval/ecearth-r3i1p1-hirham_hist_3dbc-eqm-sn2018v2005_rawbc_norway_1km_tasmin_daily_",YEAR,".nc4",sep=""),write=TRUE)
