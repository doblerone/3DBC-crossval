...
for (p in 1:length(idy))
{
  ...
  #Write to NetCDF
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/tas/CurC/xval/ecearth-r3i1p1-hirham_hist_3dbc-eqm-sn2018v2005_rawbc_norway_1km_tas_daily_",YEAR,".nc4",sep=""),write=TRUE)
