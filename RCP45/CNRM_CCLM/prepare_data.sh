...
###################
### Split yearly files into monthly files
cd /lustre/storeB/project/KSS/proj/scenariodata/Precipitation/netcdf/CNRM_CCLM/rcp45/
for file in rcp45_CNRM_CCLM_RR_daily_{2011..2100}_v4.nc
...
for m in 01 02 03 04 05 06 07 08 09 10 11 12
do cdo -r mergetime rcp45_CNRM_CCLM_RR_daily_2???_v4.nc_month${m}.nc rcp45_CNRM_CCLM_RR_daily_2011-2100_${m}.nc
done

# Remove single monthly files
rm rcp45_CNRM_CCLM_RR_daily_2???_v4.nc_month??.nc

# Split into daily files
for file in rcp45_CNRM_CCLM_RR_daily_2011-2100_??.nc
do cdo splitday $file ${file}_day
done

# Remove merged monthly files
rm rcp45_CNRM_CCLM_RR_daily_2011-2100_??.nc

# Rename files
rename "s/.nc_day//g" rcp45_CNRM_CCLM_RR_daily_2011-2100_??.nc_day??.nc
...
###################
### Split yearly files into monthly files
cd /lustre/storeB/project/KSS/proj/scenariodata/Temperature/netcdf/CNRM_CCLM/rcp45/
for file in rcp45_CNRM_CCLM_TM_daily_{2011..2100}_v4.nc
...
for m in 01 02 03 04 05 06 07 08 09 10 11 12
do cdo -r mergetime rcp45_CNRM_CCLM_TM_daily_2???_v4.nc_month${m}.nc rcp45_CNRM_CCLM_TM_daily_2011-2100_${m}.nc
done

# Remove single monthly files
rm rcp45_CNRM_CCLM_TM_daily_2???_v4.nc_month??.nc

# Split into daily files
for file in rcp45_CNRM_CCLM_TM_daily_2011-2100_??.nc
do cdo splitday $file ${file}_day
done

# Remove merged monthly files
rm rcp45_CNRM_CCLM_TM_daily_2011-2100_??.nc

# Rename files
rename "s/.nc_day//g" rcp45_CNRM_CCLM_TM_daily_2011-2100_??.nc_day??.nc
...
cp /lustre/storeB/users/andreasd/postclim/3DBC/tas/Fut/rcp45_CNRM_CCLM_TM_daily_2011-2100_????.nc .
