...
mkdir -p merged split
for m in 01 02 03 04 05 06 07 08 09 10 11 12
do cdo mergetime rcp45_CNRM_CCLM_RR_daily_2011-2100_${m}??.nc merged/rcp45_CNRM_CCLM_RR_daily_2011-2100_${m}.nc
   cdo splityear merged/rcp45_CNRM_CCLM_RR_daily_2011-2100_${m}.nc split/rcp45_CNRM_CCLM_RR_daily_${m}_
done

# remove merged month files
rm merged/rcp45_CNRM_CCLM_RR_daily_2011-2100_??.nc


# merge files for one year
for ((y=2011;y<=2100;y=y+1))
do cdo -z zip -f nc4 mergetime split/rcp45_CNRM_CCLM_RR_daily_??_${y}.nc merged/rcp45_CNRM_CCLM_RR_daily_${y}.nc
done

# remove split files
rm split/rcp45_CNRM_CCLM_RR_daily_??_????.nc
rmdir split
...
mkdir -p merged split
for m in 01 02 03 04 05 06 07 08 09 10 11 12
do cdo mergetime rcp45_CNRM_CCLM_TM_daily_2011-2100_${m}??.nc merged/rcp45_CNRM_CCLM_TM_daily_2011-2100_${m}.nc
   cdo splityear merged/rcp45_CNRM_CCLM_TM_daily_2011-2100_${m}.nc split/rcp45_CNRM_CCLM_TM_daily_${m}_
done

# remove merged month files
rm merged/rcp45_CNRM_CCLM_TM_daily_2011-2100_??.nc

# merge files for one year
for ((y=2011;y<=2100;y=y+1))
do cdo -z zip -f nc4 mergetime split/rcp45_CNRM_CCLM_TM_daily_??_${y}.nc merged/rcp45_CNRM_CCLM_TM_daily_${y}.nc
done

# remove split files
rm split/rcp45_CNRM_CCLM_TM_daily_??_????.nc
rmdir split
