...
for (d in START:END)
{
  ...
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/postclim/3DBC/tas/Fut/rcp45_EC-EARTH_HIRHAM_TM_daily_2011-2100_",daystring,".nc",sep=""))
  ...
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/postclim/3DBC/tas/FutC/rcp45_EC-EARTH_HIRHAM_TM_daily_2011-2100_",daystring,".nc",sep=""),write=TRUE)
