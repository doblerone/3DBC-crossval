...
for (d in START:END)
{
  ...
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/postclim/3DBC/pr/Fut/rcp45_MPI_CCLM_RR_daily_2011-2100_",daystring,".nc",sep=""))
  ...
  OUT <- FutCA
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/postclim/3DBC/pr/FutC/rcp45_MPI_CCLM_RR_daily_2011-2100_",daystring,".nc",sep=""),write=TRUE)
