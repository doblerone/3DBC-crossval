...
###################
### Split yearly files into monthly files
cd /lustre/storeB/project/KSS/proj/scenariodata/Precipitation/netcdf/IPSL_RCA/rcp85/
for file in rcp85_IPSL_RCA_RR_daily_2???_v4.nc
...
for m in 01 02 03 04 05 06 07 08 09 10 11 12
do cdo -r mergetime rcp85_IPSL_RCA_RR_daily_2???_v4.nc_month${m}.nc rcp85_IPSL_RCA_RR_daily_2011-2100_${m}.nc
done

# Remove single monthly files
rm rcp85_IPSL_RCA_RR_daily_2???_v4.nc_month??.nc

# Split into daily files
for file in rcp85_IPSL_RCA_RR_daily_2011-2100_??.nc
do cdo splitday $file ${file}_day
done

# Remove merged monthly files
rm rcp85_IPSL_RCA_RR_daily_2011-2100_??.nc

# Rename files
rename "s/.nc_day//g" rcp85_IPSL_RCA_RR_daily_2011-2100_??.nc_day??.nc
...
###################
### Split yearly files into monthly files
cd /lustre/storeB/project/KSS/proj/scenariodata/Temperature/netcdf/IPSL_RCA/rcp85/
for file in rcp85_IPSL_RCA_TM_daily_2???_v4.nc
...
for m in 01 02 03 04 05 06 07 08 09 10 11 12
do cdo -r mergetime rcp85_IPSL_RCA_TM_daily_2???_v4.nc_month${m}.nc rcp85_IPSL_RCA_TM_daily_2011-2100_${m}.nc
done

# Remove single monthly files
rm rcp85_IPSL_RCA_TM_daily_2???_v4.nc_month??.nc

# Split into daily files
for file in rcp85_IPSL_RCA_TM_daily_2011-2100_??.nc
do cdo splitday $file ${file}_day
done

# Remove merged monthly files
rm rcp85_IPSL_RCA_TM_daily_2011-2100_??.nc

# Rename files
rename "s/.nc_day//g" rcp85_IPSL_RCA_TM_daily_2011-2100_??.nc_day??.nc
...
cp /lustre/storeB/users/andreasd/postclim/3DBC/tas/Fut/rcp85_IPSL_RCA_TM_daily_2011-2100_????.nc .
