...
for (p in 1:length(idy))
{
  ...
  #Write to NetCDF
  nc <- nc_open(paste("/lustre/storeB/users/andreasd/KiN_2023_data/3DBC/rlds/CurC/xval/ecearth-r12i1p1-cclm_hist_3dbc-eqm-hysn2018v2005era5_rawbc_norway_1km_rlds_daily_",YEAR,".nc4",sep=""),write=TRUE)
